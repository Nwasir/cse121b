...
// Step 3: Step 3: Using function declaration, define another function named addNumbers that gets the
//values of two HTML form controls with IDs of addend1 and addend2. Pass them to the add function
function addNumbers() {
  let no1 = parseInt(document.querySelector("#addend1").value);
  let no2 = parseInt(document.querySelector("#addend2").value);
  let sum = add(no1, no2);
...
function subtractNumbers() {
  let minus = parseInt(document.querySelector("#minuend").value);
  let subtraction = parseInt(document.querySelector("#subtrahend").value);
  let sub = subtract(minus, subtraction);
...
// Step 7: Using arrow functions, repeat Steps 1-5 with new functions named multiply and mulitplyNumbers and HTML
//form controls with IDs of factor1, factor2, product and multiplyNumbers
let multiply = (number1, number2) => number1 * number2;

let mulitplyNumbers = () => {
  let figure1 = parseInt(document.querySelector("#factor1").value);
  let figure2 = parseInt(document.querySelector("#factor2").value);
  let mult = multiply(figure1, figure2);
...
// Step 8: Using any of the three function declaration types, repeat Steps 1-5 with new functions named divide
//and divideNumbers and HTML form controls with IDs of dividend, divisor, quotient and divideNumbers
let divide = (number1, number2) => number1 / number2;

let divideNumbers = () => {
  let div1 = parseInt(document.querySelector("#dividend").value);
  let div2 = parseInt(document.querySelector("#divisor").value);
  let div3 = divide(div1, div2);

  document.querySelector("#quotient").value = div3;
};
document
...
// Step 3: Using the variable declared in Step 1, call the built-in getFullYear() method/function and assign it
// to the variable declared in Step 2
...
// Step 5: Use the reduce array method to sum the array variable elements and assign the
//result to the HTML element with an ID of "sumOfArray"
const sumOfArray = numbers.reduce((total, number) => total + number);
...
const sumOfMultiplied = multiplyArray.reduce((total, number) => total + number);
