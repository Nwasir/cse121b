...
//     let Ggrades = document.querySelector("#grades").value;
//     // split them into an array (String.split(','))
//     let splitGrade = Ggrades.split(",");
//     // clean up any extra spaces, and make the grades all uppercase. (Array.map())
//     let cleanGrades = splitGrade.map((grade) => {grade.trim().toUpperCase()});
...
//     let gradePoint = grades.map((grade) => lookupGrade(grade));
//     // calculates the GPA
//     const gpa =
//     gradePoint.reduce((total, item) => total + item) / gradePoint.length;
//     // return the GPA
